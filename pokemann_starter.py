...
if __name__ == '__main__':
    ...
    call_parents = Move("Call Parents", "administrator", 4, 40, 70)
    ...
    coopasaur = Pokemann("Coopasaur", "teacher", 30, 20, 50, 100, 100, [homework, pop_quiz, ask_id], "coopasaur.png")
    cookmander = Pokemann("Cookmander", "teacher", 30, 20, 50, 100, 100, [lecture, ask_id, homework], "cookmander.png")
    vincolairy = Pokemann("Vincolairy", "teacher", 30, 20, 50, 120,100, [lecture, ask_id, homework], "vincolairy.png")
    mayfieldarow = Pokemann("Mayfieldarow", "administrator", 30, 20, 50, 90, 100, [restrict_lunch, fired, expulsion], "mayfieldarow.png")
    andrewag = Pokemann("Andrewag", "student", 30, 20, 50, 150, 100, [complaining, phone_out, no_hw], "andrewag.png")
    caseypuff = Pokemann("Caseypuff", "student", 30, 20, 50, 170, 100, [complaining, phone_out, no_hw], "caseypuff.png")
    colboreon = Pokemann("Colboreon", "student", 30, 20, 50, 80, 100, [complaining, phone_out, no_hw], "colboreon.png")
    blakachu = Pokemann("Blakachu", "student", 30, 20, 50, 130, 100, [complaining, phone_out, no_hw], "blakachu.png")
    zoeotto = Pokemann("Zoeotto", "student", 30, 20, 50, 100, 100, [complaining, phone_out, no_hw], "zoeotto.png")
    morganyta = Pokemann("Morganyta", "student", 30, 20, 50, 160, 100,[complaining, phone_out, no_hw], "morganyta.png")
    katlevee = Pokemann("Katlevee", "student", 30, 20, 50, 140, 100, [complaining, phone_out, no_hw], "katlevee.png")
    marcelax = Pokemann("Marcelax", "student", 30, 20, 50, 30, 100, [complaining, phone_out, no_hw], "marcelax.png")
